...
class TestLoader:
    ...
    def test_load_abstract_class_raises_plugin_error(self) -> None:
        ...
        mock_entry_point.load.return_value = Discover
        loader.entry_points["fake.abstract"] = mock_entry_point
    ...
    def test_load_wrong_subclass_raises_plugin_error(self) -> None:
        ...
        mock_entry_point = MagicMock()
        mock_entry_point.load.return_value = NotADiscover
        loader.entry_points["fake.wrong_type"] = mock_entry_point
